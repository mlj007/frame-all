...
import com.chexun.base.common.image.ImageUtils.Position;
...
public class AverageImageScale {
	 ...
	 * @throws IOException
	 */
	public static void cut(File srcFile, File destFile, int cutTop, int cutLeft, int cutWidth, int catHeight)
			throws IOException {
		BufferedImage srcImgBuff = ImageIO.read(srcFile);
	...
	public static void main(String[] args) throws Exception {
		...
		AverageImageScale.resizeFix(new File("test/com/cc/common/util/1.bmp"),
				new File("test/com/cc/common/util/1-n-2.bmp"), 310, 310, 50,
				50, 320, 320);
