...
<body>
    ...
    <div class="formbody">
    	...
    	<form method="post" action="/manage/system/${voClassName?lower_case}/add">
    	<ul class="forminfo">
    		<#list columnList as column>
    		<li><label>${column.propertyName}</label><input name="${column.propertyName}" type="text" class="dfinput" /><i>${column.propertyName}不能超过30个字符</i></li>
    		</#list>
