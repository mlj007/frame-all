...
public class RandomCodeController extends BaseController{
    ...
    // 返回页面定义
    private static String LOGIN = "/admin/login/login";// 登录页面
    
 // 验证码
 	public static final String RAND_CODE = "user_rand_code";
...
//        HttpSession session = request.getSession();
        ...
        this.setSessionAttribute(request, response, session.getId() + RAND_CODE, sRand);
    ...
    @RequestMapping("/rkzxbg/administrator")
