...
import com.chexun.base.cache.ICache;
...
public class CacheUtil {
	...
	public static <B extends ICache<?, ?>> ICacheManager<B> getCacheManager(Class<B> cache, String defaultImplClass) {
		...
		cacheManager = (ICacheManager<B>) getInstanceByInterface(ICacheManager.class, Thread.currentThread().getContextClassLoader(), defaultImplClass, true);
