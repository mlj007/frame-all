...
import com.chexun.base.cache.memcached.client.ErrorHandler;
import com.chexun.base.cache.memcached.client.MemCachedClient;
import com.chexun.base.cache.memcached.client.SockIOPool;
...
public class MemcachedCacheManager implements ICacheManager<IMemcachedCache>
{
	...
	/* (non-Javadoc)
	 * @see com.jinkao.cache.ICacheManager#start()
	 */
	public void start()
	{
	...
	/* (non-Javadoc)
	 * @see com.jinkao.cache.ICacheManager#stop()
	 */
	public void stop()
	{
